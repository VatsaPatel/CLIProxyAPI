...
<tbody>
    ...
    <tr>
        ...
        <td>Anthropic Claude series models (Claude Fable, Claude Opus, Claude Sonnet, etc.). Claude Fable 5.1 is Anthropic's latest model for demanding reasoning, long-horizon agents, and complex knowledge work.</td>
    </tr>
    <tr>
