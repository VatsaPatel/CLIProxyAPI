...
func buildConfigModels[T modelEntry](models []T, ownedBy, modelType string) []*ModelInfo {
	...
	for i := range models {
		...
		info.InputTokenLimit = resolved.InputTokenLimit
		info.OutputTokenLimit = resolved.OutputTokenLimit
		info.SupportedGenerationMethods = append([]string(nil), resolved.SupportedGenerationMethods...)
